...
// for c3508
#define C3508_WDT_CFG_WDT_TRIGGER_REPORT      BIT7
#define C3508_WDT_CFG_WDT_M3_ENABLE           BIT3
#define C3508_WDT_CFG_WDT_M2_ENABLE           BIT2
#define C3508_WDT_CFG_WDT_M1_ENABLE           BIT1
#define C3508_WDT_CFG_WDT_ENABLE              BIT0
// #define EC_LPC_IO_BASE_ADDR     0x6300
#define C3508_EC_WDT_TIMER_MIN_REG_OFFSET         0x07  // minutes
#define C3508_EC_WDT_TIMER_SEC_REG_OFFSET         0x08  // second
#define C3508_EC_WDT_CFG_REG_OFFSET               0x06
#define C3508_CPLD_WDT_TRG_REG_OFFSET             0x28

#define CPU_TYPE_DEFAULT 0
#define CPU_TYPE_C3508 1
#define CPU_TYPE_D1627 2
...
void hisonic_wdt_drivers_register(struct wdt_drivers_t *p_func);
void hisonic_wdt_drivers_unregister(void);
void kssonic_wdt_drivers_register(struct wdt_drivers_t *p_func);
void kssonic_wdt_drivers_unregister(void);
void mxsonic_wdt_drivers_register(struct wdt_drivers_t *p_func);
