...
struct mainboard_drivers_t{
    ...
    ssize_t (*get_switch_mac) (char* buf);
    ssize_t (*get_vendor) (char* buf);
    ssize_t (*get_label_revision) (char* buf);
...
void hisonic_mainboard_drivers_register(struct mainboard_drivers_t *p_func);
void hisonic_mainboard_drivers_unregister(void);
void kssonic_mainboard_drivers_register(struct mainboard_drivers_t *p_func);
void kssonic_mainboard_drivers_unregister(void);
void mxsonic_mainboard_drivers_register(struct mainboard_drivers_t *p_func);
